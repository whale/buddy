...
- [x] **3. Donezo placement** — ✅ done via item 10 (Donezo now at top of the card).
...
- [x] **11. Morning view styling** — ✅ stacked date header + bordered card + grey Skip / black Buddy! pill, matches `mac-morning`.
- [x] **12. Final sweep** — ✅ verified lvl0 + lvl2 (red) + morning vs Mac references; all match. Minor optional polish noted below.
