...
- **List size** — choose **3–6 active tasks** in Settings, synced between updated Mac and iPhone apps. Completed tasks do not count. Limits below your current active-task count are unavailable. Hover or focus to see why; clicking or tapping opens a centered Buddy dialog explaining how many tasks to complete or move to Future first. Its single, left-aligned OK button only dismisses the explanation. Changing the limit never moves tasks for you.
